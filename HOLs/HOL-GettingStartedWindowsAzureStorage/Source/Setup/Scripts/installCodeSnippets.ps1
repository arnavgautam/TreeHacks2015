...
foreach ($node in $vscontent.VSContent.Content)
{
    ...
    {       
        "XML" { Copy-Item "$codeSnippetFile" -destination "$documentsFolder\Visual Studio 2013\Code Snippets\XML\My Xml Snippets" -force } 
        "XAML" { Copy-Item "$codeSnippetFile" -destination "$documentsFolder\Visual Studio 2013\Code Snippets\XAML\My XAML Snippets" -force }       
		"HTML" { Copy-Item "$codeSnippetFile" -destination "$documentsFolder\Visual Studio 2013\Code Snippets\Visual Web Developer\My HTML Snippets" -force } 
		"CSS" { Copy-Item "$codeSnippetFile" -destination "$documentsFolder\Visual Studio 2013\Code Snippets\Visual Web Developer\My CSS Snippets" -force } 
        "JavaScript" { Copy-Item "$codeSnippetFile" -destination "$documentsFolder\Visual Studio 2013\Code Snippets\JavaScript\My Code Snippets" -force }  
		"csharp" { Copy-Item "$codeSnippetFile" -destination "$documentsFolder\Visual Studio 2013\Code Snippets\Visual C#\My Code Snippets" -force } 
        "vb" { Copy-Item "$codeSnippetFile" -destination "$documentsFolder\Visual Studio 2013\Code Snippets\Visual Basic\My Code Snippets" -force } 
        "SQL" { Copy-Item "$codeSnippetFile" -destination "$documentsFolder\Visual Studio 2013\Code Snippets\SQL\My Code Snippets" -force }         
