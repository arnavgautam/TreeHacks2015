...
DEL "%MyDocuments%\Visual Studio 2012\Code Snippets\Visual C#\My Code Snippets\IntroductionToACS2Ex*.snippet" 2>NUL
DEL "%MyDocuments%\Visual Studio 2012\Code Snippets\XML\My Xml Snippets\IntroductionToACS2Ex*.snippet" 2>NUL
