...
DEL "%MyDocuments%\Visual Studio 2012\Code Snippets\Visual C#\My Code Snippets\WindowsAzureDebuggingEx*.snippet" 2>NUL
DEL "%MyDocuments%\Visual Studio 2012\Code Snippets\XML\My Xml Snippets\WindowsAzureDebuggingEx*.snippet" 2>NUL
