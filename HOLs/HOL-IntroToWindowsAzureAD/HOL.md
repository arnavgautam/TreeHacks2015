...
1. Click **Manage Manifest** in the bottom toolbar and select **Download Manifest**.
	...
	1. Open the application manifest file with **Visual Studio**. At the top of the file, find the requiredResourceAccess section.
...
1. Add the following section to the requiredAppPermissions subsection, before the existing one, and save the file.
