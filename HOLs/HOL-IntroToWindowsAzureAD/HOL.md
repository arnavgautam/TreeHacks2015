...
1. Click on the **Application** tab to display the list of applications and click the application name you created in the previous exercise to go to its dashboard.
