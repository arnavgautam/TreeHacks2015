...
1.	In the application dashboard click the **ENABLE USERS TO SIGN ON** link to display information to enable single sign-on with Windows Azure AD. You will then see where the **Federation Metadata Document URL** and **App ID URI** were configured by the MVC new project assistant.
