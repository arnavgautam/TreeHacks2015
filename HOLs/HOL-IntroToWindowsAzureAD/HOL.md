...
1.	In the application dashboard you can find the necessary information to enable single sign-on with Microsoft Azure AD. You will then see where the **Federation Metadata Document URL** and **App ID URI** were configured by the MVC new project assistant.
