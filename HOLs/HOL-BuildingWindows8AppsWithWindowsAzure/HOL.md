...
Apps are at the center of the Windows 8.1 experience. They’re alive with activity and vibrant content. Users are immersed in your full-scree, Windows Store apps, where they can focus on their content, rather than on the operating system.
...
ASP.NET Web API is a new framework from MVC 5 that facilitates the process of building and consuming HTTP services for a wide range of clients.
...
1. In the **New Project** dialog, select the **Blank App** under the **Visual C# | Windows Store** applications. Name it _Win8Client_ and click **OK**.
	...
	> **Note:** If it's the first time you create a Windows Style UI application you will be prompted to get a developer license for Windows 8.1 to develop this kind of applications. In the Developer License window, click **I Agree**.
...
1. Add the following method to the **MainPage.xaml.cs** class, to perform an asynchronous call to the Web API service.
	...
	(Code Snippet - _BuildingWindows8.1Apps - Ex1 - GetItems_)
	<!-- mark:1-22 -->
	````C#
...
1. Replace the value of the placeholder _[YOUR-WINDOWS-AZURE-SERVICE-URL]_ with your Windows Azure published web site URL. You can check that value in the web site's dashboard.
