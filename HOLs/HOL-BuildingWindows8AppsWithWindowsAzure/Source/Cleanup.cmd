...
DEL "%MyDocuments%\Visual Studio 2013\Code Snippets\Visual C#\My Code Snippets\BuildingWindows8AppsEx*.snippet" 2>NUL
DEL "%MyDocuments%\Visual Studio 2013\Code Snippets\XML\My Xml Snippets\BuildingWindows8AppsEx*.snippet" 2>NUL
