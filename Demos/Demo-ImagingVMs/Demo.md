...
1.	Create a new **Windows Server 2012 Datacenter** virtual machine in the **Microsoft Azure Management** portal using the gallery. Set the virtual machine name to _iisvm2_.
...
1. Press **OK** and wait for the virtual machine to show the **Stopped** status in the Microsoft Azure Management portal.
