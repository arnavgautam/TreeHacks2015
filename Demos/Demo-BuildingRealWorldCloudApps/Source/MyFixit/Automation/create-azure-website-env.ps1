...
# create-azure-website-env.ps1 -Name yourwebsitename -Location "West Europe" -SqlDatabasePassw0rd P@ssw0rd
...
$storageConnectionString = ("DefaultEndpointsProtocol=https;AccountName={0};AccountKey={1}" -f $storageAccountName, $storage.AccessKey);
...
Write-Verbose ("{0} = {1}" -f "StorageConnectionString", $storageConnectionString)
