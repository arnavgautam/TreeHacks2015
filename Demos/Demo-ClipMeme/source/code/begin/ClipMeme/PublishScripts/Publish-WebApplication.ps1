<#
.SYNOPSIS
Creates and deploys Windows Azure Web Sites for a Visual Studio web project.
For more detailed documentation go to: http://go.microsoft.com/fwlink/?LinkId=391217 

.EXAMPLE
C:\> .\Publish-WebApplication.ps1 -Configuration .\Configurations\WebApp1-WAWS.json -WebDeployPackage ..\Publish\WebApp1.zip -Verbose
#>
