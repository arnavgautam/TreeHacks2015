...
REM %powerShellDir%\powershell.exe -NonInteractive -ExecutionPolicy Unrestricted -command ".\Setup\cleanup.azure.ps1" ".\config.primary.xml"
...
%powerShellDir%\powershell.exe -NonInteractive -ExecutionPolicy Unrestricted -command ".\setup\setup.local.ps1" ".\config.primary.xml" "$true"
echo.
